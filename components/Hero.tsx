...
/**
 * A small, tasteful circuit trace with a travelling pulse, sitting beside the
  ...
  return (
    <section id="home" aria-labelledby="hero-heading" className="relative">
      <div className="mx-auto w-full max-w-6xl px-5 pb-16 pt-28 sm:px-6 md:pb-24 md:pt-36">
        ...
        <p className="mt-6 max-w-2xl text-base leading-relaxed text-slate-400 sm:text-lg">{person.summary}</p>
        ...
        <a
          href="#about"
          className="mt-16 inline-flex items-center gap-2 text-sm font-medium text-slate-500 transition-colors hover:text-accent-400"
        >
